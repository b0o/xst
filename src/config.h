...
/* xresources identifier */
static char *xresources = "xst";
...
static char *colorname[] = {
    "#1e1e1e", "#cf6a4c", "#8f9d6a", "#f9ee98", "#7587a6", "#9b859d",
    "#afc4db", "#a7a7a7", "#5f5a60", "#cda869", "#323537", "#464b50",
    "#838184", "#c3c3c3", "#9b703f", "#ffffff",
...
static Shortcut shortcuts[] = {
    ...
    {MODKEY,
     'u',
     externalpipe,
     {.v = "raw=\"$(</dev/stdin)\"; urls=($(echo \"${raw}\" | xurls | uniq)); "
           "[[ ${#urls[@]} -gt 0 ]] && printf '%s\n' \"${urls[@]}\" | dmenu | "
           "xargs xdg-open"}},
